export default function HomeMission() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-secondary/5 to-background py-12 sm:py-16">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <div className="text-center">
          <div className="inline-flex items-center rounded-full border border-primary/20 dark:border-primary/30 bg-white/80 dark:bg-slate-800/80 px-3 py-1 text-xs font-medium text-primary backdrop-blur-sm">
            Our Mission
          </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="group rounded-xl border border-slate-200/60 dark:border-slate-700/60 bg-white/80 dark:bg-slate-800/80 p-5 backdrop-blur-sm transition hover:border-primary/30 hover:shadow-lg">
          ...
          <div className="group rounded-xl border border-slate-200/60 dark:border-slate-700/60 bg-white/80 dark:bg-slate-800/80 p-5 backdrop-blur-sm transition hover:border-secondary/30 hover:shadow-lg">
          ...
          <div className="group rounded-xl border border-slate-200/60 dark:border-slate-700/60 bg-white/80 dark:bg-slate-800/80 p-5 backdrop-blur-sm transition hover:border-accent/30 hover:shadow-lg">
