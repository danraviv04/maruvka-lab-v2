        ...
        <Container>
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div className="rounded-xl bg-white dark:bg-slate-800 border border-blue-100 dark:border-blue-900 p-6 shadow-sm hover:shadow-md transition">
              ...
              <div className="rounded-xl bg-white dark:bg-slate-800 border border-purple-100 dark:border-purple-900 p-6 shadow-sm hover:shadow-md transition">
                <div className="text-4xl mb-3">🔬</div>
              ...
              <div className="rounded-xl bg-white dark:bg-slate-800 border border-teal-100 dark:border-teal-900 p-6 shadow-sm hover:shadow-md transition">
                <div className="text-4xl mb-3">💻</div>
